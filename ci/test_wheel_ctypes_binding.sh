...
# NUMBA_CUDA_USE_NVIDIA_BINDING=0 NUMBA_CUDA_TEST_BIN_DIR=$NUMBA_CUDA_TEST_BIN_DIR python -m pytest numba_cuda_tests -v
NUMBA_CUDA_USE_NVIDIA_BINDING=0 python -m pytest numba_cuda_tests -v
