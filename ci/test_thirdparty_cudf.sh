...
python -m pytest python/cudf/cudf/tests/groupby/test_apply.py -k 'test_groupby_apply_jit or test_groupby_apply_return_reindexed_series' -W ignore::UserWarning
